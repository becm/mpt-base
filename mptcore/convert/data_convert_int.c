 ...
 */
extern int mpt_data_convert_int8(const int8_t *from, int type, void *dest)
{
	int8_t val = 0;
	if (from) {
		val = *from;
 ...
 * \retval >0               destiantion data size
 */
extern int mpt_data_convert_uint8(const uint8_t *from, int type, void *dest)
{
	uint8_t val = 0;
	if (from) {
		val = *from;
 ...
 * \retval >0               destiantion data size
 */
extern int mpt_data_convert_int16(const int16_t *from, int type, void *dest)
{
	int16_t val = 0;
	if (from) {
		val = *from;
 ...
 * \retval >0               destiantion data size
 */
extern int mpt_data_convert_uint16(const uint16_t *from, int type, void *dest)
{
	uint16_t val = 0;
	if (from) {
		val = *from;
 ...
 * \retval >0               destiantion data size
 */
extern int mpt_data_convert_int32(const int32_t *from, int type, void *dest)
{
	int32_t val = 0;
	if (from) {
		val = *from;
 ...
 * \retval >0               destiantion data size
 */
extern int mpt_data_convert_uint32(const uint32_t *from, int type, void *dest)
{
	uint32_t val = 0;
	if (from) {
		val = *from;
 ...
 * \retval >0               destiantion data size
 */
extern int mpt_data_convert_int64(const int64_t *from, int type, void *dest)
{
	int64_t val = 0;
	if (from) {
		val = *from;
 ...
 * \retval >0               destiantion data size
 */
extern int mpt_data_convert_uint64(const uint64_t *from, int type, void *dest)
{
	uint64_t val = 0;
	if (from) {
		val = *from;
