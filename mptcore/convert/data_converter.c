...
static int _mpt_convertable_wrap(const void *from, int type, void *dest)
{
...
static int _mpt_metatype_wrap(const void *from, int type, void *dest)
{
...
extern MPT_TYPE(data_converter) mpt_data_converter(int type)
{
