		...
		switch (ftype) {
		  ...
		  case 'b':
			switch (dtype) {
			  ...
			  case 'I':
			  case 'o':
			  case 'x': if (*((int8_t *) from) < 0) return -2;
		  ...
		  case 'i':
			switch (dtype) {
			  ...
			  case 'I':
			  case 'o':
			  case 'x': if (*((int32_t *) from) < 0) return -2;
		  ...
		  case 'x':
			switch (dtype) {
			  ...
			  case 'I':
			  case 'o':
			  case 'x': *((uint32_t *) dest) = *((uint32_t *) from); break;
			  case 'L':
			  case 'O':
			  case 'X':
		  ...
		  case 'l':
			switch (dtype) {
			  ...
			  case 'I':
			  case 'o':
			  case 'x': if (*((int64_t *) from) < 0 || *((int64_t *) from) > UINT32_MAX) return -2;
			  ...
			  case 'L':
			  case 'O':
			  case 'X': if (*((int64_t *) from) < 0) return -2;
		  ...
		  case 'X':
			switch (dtype) {
			  ...
			  case 'I':
			  case 'o':
			  case 'x': if (*((uint64_t *) from) > UINT32_MAX) return -2;
				    *((uint32_t *) dest) = *((uint64_t *) from); break;
			  case 'l': if (*((uint64_t *) from) > INT64_MAX) return -2;
			  case 'L':
			  case 'O':
			  case 'X': *((int64_t *) dest) = *((uint64_t *) from); break;
			  case 'g':
			  case 'e':
		  ...
		  case 'D':
			switch (dtype) {
			  ...
			  case 'D': *((long double *) dest) = *((long double *) from); break;
			  default: return -3; /* invalid conversion */
			}
			break;
#endif
